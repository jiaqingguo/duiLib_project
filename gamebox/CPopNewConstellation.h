...
class CPopNewConstellation : public WindowImplBase
{
public:
	static int MessageBox(HWND hParent)
	{
		CPopNewConstellation* pWnd = new CPopNewConstellation();
	...
	CPopNewConstellation();
	~CPopNewConstellation(void);

	string GetNewName();//获取修改后的名称
...
public:
	...
	static string m_newName;//修改后的节点名称
