...
public:
	...
	vector<string> m_vecDqzTxName; // 存放地球站天线名称;
	vector<map<string, string>> m_vecMapDqzTxData;
	vector<string> m_vecDqzkyName; // 存放地球站kuiyuan名称;
	vector<map<string, string>> m_vecMapDqzKyData;
